class ViewCadastro {
    ...
    fun apartmentView(){
        ...
        Controller.criaApartamento("Apartamento","999343672",221.14,
            3,1,2,112.12,endereco)
    }

    fun houseView(){
        println("cadastrando casa")
        Controller.criaCasa("casa","839994223",endereco,
            222.1,333.5,3,2)
    }

    fun terrenoView(){
        println("cadastrando terreno")
        Controller.criaTerreno("terreno", "8333333",endereco,223.6,1,2224.4)
    }
}